...
var InitPixel = function( args ) {
	...
	if( currentSlide.resizeable ) { queryString.resizeable = true; }
	...
	return function callback () {
		...
		if( ImageFunction ) {
			...
			renderObject = {
				...
				pixelSize: ( queryString.p || currentSlide.p || 7 ) * 1 + ( queryString.pAdd || imageFunction.recommendedPixelSize || 0 ) * 1,
				socket: socket,
...
InitPixel.prototype.showcaseSlides = [
	...
	{ name: "graien", niceName: "Die 3 Graien", resizeable: true, unchangeable: true, sliders: true },
	{ name: "brothers", niceName: "Brüder", resizeable: true },
	{ name: "zeus", niceName: "Zeus", resizeable: true },
	{ name: "argos", niceName: "Die Argos", resizeable: true },
	{ name: "sphinx", niceName: "Die Sphinx", resizeable: true },
	// { name: "letter", niceName: "Buchstabe", unchangeable: true, both: true },
	{ name: "persons_lessrandom", niceName: "Trees", hasRandom: true },
	{ name: "persons_lessrandom", niceName: "Personen", sliders: true, showPerson: true, hasRandom: true },
	{ name: "table2", niceName: "Comic", unchangeable: true, sliders: true, hasRandom: true },
];