...
Comic.prototype.Actors.prototype = {
			...
			list:[
				...
				args.debug && {
					list:[
						...
						// Stage Marks
						{ color:[180,80,0], stripes:{ strip:{r:0.1} }, sY:{r:2}, list:[
							{ sX:1 }
						] },
	...
	addTrack : function ( i ) {
		var tracker = this.tracker,
			...
			actor2Array = [],
			name = [],
			addActor = function ( actorArray, actor) {
