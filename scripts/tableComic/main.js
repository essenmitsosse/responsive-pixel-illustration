...
var TableComic = window.renderer = function( init, slide ) {
	var sX, sY, square, margin, doubleMargin, innerSX, innerSY, innerSquare, 
	...
	( function( comicPrototype ) {
		var current,
			addHoverChange = hover.addHoverChange,
			functionList = hover.functionList,
			colorList = hover.colorList;
