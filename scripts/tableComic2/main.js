...
var TableComic = window.renderer = function( init, slide, createSlider ) {
	var sX, sY, square, margin, doubleMargin, innerSX, innerSY, innerSquare, innerSquareBig, innerSquareAverage,
		controlerSX, controlerSY, controlerX, controlerY,
	...
	if( createSlider ) {
		if( faceVersion ) {
			createSlider.slider( { niceName: "A",			valueName: "a",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "B",			valueName: "b",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "C",			valueName: "c",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "D",			valueName: "d",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "E",			valueName: "e",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "F",			valueName: "f",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "G",			valueName: "g",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "H",			valueName: "h",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "I",			valueName: "i",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "J",			valueName: "j",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "K",			valueName: "k",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "L",			valueName: "l",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "M",			valueName: "m",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "N",			valueName: "n",					defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			
			createSlider.slider( { niceName: "Side",		valueName: "side",				defaultValue: 0.5, 	input: { min: 0, 	max: 1, step: 0.02 } } );
			createSlider.slider( { niceName: "Kamera",		valueName: "camera",			defaultValue: 0, 	input: { min: 0, 	max: 1, step: 0.02 } } );
