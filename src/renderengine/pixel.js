    ...
    var old = [],
        ...
        oneD = (function () {
            ...
            Dimension.prototype.createAdder = function (add, onlyAdd) {
                ...
                this[onlyAdd ? "realPartCalculation" : "getRealDistance"] =
                    onlyAdd
            ...
            Dimension.prototype.getGetLengthCalculation = function (x, y) {
                ...
                return function () {
                    return Math.round(
                        Math.sqrt(
                            Math.pow(x.getReal(), 2) + Math.pow(y.getReal(), 2),
                        ),
                    );
                };
            };
            ...
            Dimension.prototype.getRealDistanceWithCalcOnlyAdding =
                function () {
                    var add = 0,
                        adder = this.adder,
                        l = adder.length;
            ...
            Dimension.prototype.getRealDistanceWithMaxMin = function (
                max,
                min,
                Dim,
            ) {
                ...
                return max && min
                    ? function () {
                          var a,
                              realMin =
                                  typeof min === "number" ? min : min.getReal(),
                              realMax =
                                  typeof max === "number" ? max : max.getReal();
                            ...
                            var a,
                                realMin =
                                    typeof min === "number"
                                        ? min
                                        : min.getReal();
                            return (a = this.getRealDistance()) < realMin
                                ? realMin
                                : a;
                        };
            };
        ...
        Axis = (function () {
            ...
            Axis.prototype.getCalcPos = {
                ...
                fromOther: function () {
                    return (
                        this.pos.fromOtherSide(this.realSize) - this.realMargin
                    );
                },
            ...
            return {
                ...
                set: function (dimensions) {
                    ...
                    AxisY.prototype.dim = PosY.prototype.dim =
                        dimensions.height;
                },
            };
        })(),
