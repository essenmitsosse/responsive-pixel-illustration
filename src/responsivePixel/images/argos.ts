...
const wood: ColorRgb = [155, 114, 70],
  wood1: ColorRgb = [143, 92, 57],
  wood2: ColorRgb = [177, 124, 62],
  wood3: ColorRgb = [130, 99, 64],
  woodDark: ColorRgb = [60, 51, 45],
  holes: ColorRgb = [64, 37, 19],
  sail: ColorRgb = [208, 202, 202],
  string: ColorRgb = [171, 177, 190],
  oar: ColorRgb = [131, 93, 39],
  paddle: ColorRgb = [219, 216, 211],
  ram: ColorRgb = [149, 136, 100],
  slaveSkin: ColorRgb = [162, 142, 128],
  slaveCloth: ColorRgb = [65, 71, 79],
  spear: ColorRgb = [151, 176, 175],
  spearTip: ColorRgb = [137, 137, 137],
  argoCloth: ColorRgb = [108, 50, 50],
  argoSkin: ColorRgb = [200, 172, 151],
  argoHelm: ColorRgb = [161, 133, 88],
  water: ColorRgb = [26, 59, 120],
  water1: ColorRgb = [0, 36, 102],
  water2: ColorRgb = [9, 22, 71],
  foam: ColorRgb = [245, 249, 255],
  backgroundColor: ColorRgb = [165, 239, 255],
  cloud: ColorRgb = [198, 245, 255],
