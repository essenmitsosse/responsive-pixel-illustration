...
const shadowColor: ColorRgb = [255, 255, 255],
  ...
  shadowSoft = getDarken(shadowColor, 0.9),
  detailColor = getDarken(shadowColor, 0.4),
  lighten = getLighten(shadowColor, 0.3),
  lightenSoft = getLighten(shadowColor, 0.1),
  c3: ColorRgb = [0, 0, 255],
  zBackground: ColorRgb = [200, 150, 255],
  zSkin = shadow(zBackground),
  zSkinShadow = shadow(zSkin),
  zHair = lighten(zBackground),
  zCloth = detailColor(zBackground),
  flash: ColorRgb = [255, 220, 180],
  hBasic: ColorRgb = [210, 100, 20],
  hSkin = shadow(hBasic),
  hHair = lighten(hBasic),
  hCloth = detailColor(hBasic),
  hBackground = hBasic,
  pBasic: ColorRgb = [116, 150, 150],
  pSkin = shadow(pBasic),
  pHair = lighten(pBasic),
  pCloth = detailColor(pBasic),
  pBackground = pBasic,
  borderDetail = shadow(zCloth),
  backgroundColor = detailColor(borderDetail),
  flashForm = [
    {
      points: [
        { y: { r: 0.4 } },
