...
Builder.prototype.Person = function (args) {
  ...
  this.vL[`shoulderHeadSX${nr}`] = this.bigHead
    ? `shoulderSX${nr}`
    : {
        add: [`headSX${nr}`, `armWid${nr}`, 1, this.sub(`personSX${nr}`)],
        min: 1,
      };
...
Builder.prototype.Face = function (args) {
  ...
  this.beard = this.IF();
  this.moustach =
    ((this.beard && this.IF(0.6)) || this.IF()) && new this.basic.Beard(args);
  ...
  return {
    ...
    list: [
      ...
      // ARM
      {
        rotate: shoulder,
        rY:
          ((!args.back && !this.right) || (args.back && this.right)) &&
          shoulder90,
        list: [
          { name: "Dot", clear: true, fX: true },
          {
            ...
            list: [
...

              {
                ...
                y:
                  ...
                  this.sub(`armWid${nr}`),
                color:
                  (this.topless || this.shortSleves) && this.skinColor.get(),
                list: [
                  {
                    tY: true,
                    fY: true,
