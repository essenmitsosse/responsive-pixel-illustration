...
Comic.prototype.World.prototype = {
	...
	draw(args) {
		let groundSY; let groundTopSY;
		let skySY;
		let stageSX; let stageSY; let stageSquare;
		let stageDoubleX; let stageDoubleY;
		let stageCenterX; let stageCenterY;
		let stageX; let stageY;
