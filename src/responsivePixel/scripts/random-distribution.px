		...
		renderList = ( function () {
			...
			var count = rInt(5,20),
				...
				getSquare = function () {
					...
					linkList.push( innerS = { r:rFl(minSize,maxSize), useSize:s, odd:true, test:true } );
