...
TableComic.prototype.Table.prototype.draw = function TableDraw ( args ) {
	...
	this.topSY = this.pushLinkList( { r: 0.1 * this.sY_, useSize: args.stageSY, max: this.sY, min: 1 } );
	...
	return this.getObject([
		...
		// Table Foot
		{
			sX: this.footSX,
			cX: true,
			sY: { r:0.05 * this.sY_, useSize: args.stageSY, max: this.sY, min: 1 },
			fY: true
		},
...
TableComic.prototype.Chair.prototype.draw = function ChairDraw ( args ) {
	...
	return this.getObject([
		...
		// Seat
		{ sY: this.horizontalElement, list: [
			{},
