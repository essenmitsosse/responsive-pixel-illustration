				...
				list: {
					...
					actor0: { // actor 0 — frame 1
						start: {
							...
							pos: { relPos: actor0StandUp, value:{
								posX: 0.3,
								posY: 0,
								obj: stage
							} },
							...
							body: { side: 0.7 },
							armLeft: { relPos: actor0StandUp, value: {
							...
							armRight: { relPos: actor0StandUp, value: {
								pos: {
									map: "a",
