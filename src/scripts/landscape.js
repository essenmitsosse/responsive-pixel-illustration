...
function landscape() {
  ...
  var colorNr = helper.getRandomInt(4)
  var dayNight = helper.getRandomInt(2)
  var sunPos = helper.getRandomInt(2)
  var mountains = helper.getRandomInt(2)
  var clouds = helper.getRandomInt(2)
  var tree = helper.getRandomInt(2)
  var colorScheme = [
    [
      [255, 255, 255],
      [180, 180, 180],
